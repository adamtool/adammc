 ...
 */
public class SDN2Pdf extends AbstractSimpleModule {

    private static final String name = "sdn2pdf";
    private static final String descr = "Converts a Software Defined Networks topology (with an concurrent update)"
            + " to a Petri net with transits and saves this to a pdf file by using Graphviz (dot has to be executable).";
    ...
    public void execute(CommandLine line) throws IOException, ParseException, InterruptedException, CommandLineParseException, ClassNotFoundException, Exception {
        ...
        PNWTTools.savePnwt2PDF(IOParameters.getOutput(line), pnwt, true);
    }
